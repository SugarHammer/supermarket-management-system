...
<html>
	...
	<body style="background: #EEEEEE; ">
		...
		<div class="login-bg" style="background-image: url(../../img/bj.png);"></div>

		<div class="login-container">
			<!-- 标题 -->
			<h2 class="index-title" style="width: 480px;">USER / REGISTER</h2>
			<div class="line-container">
				<p class="line"> 留言板注册 </p>
			</div>
			<!-- 标题 -->
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="username" name="username" placeholder="请输入留言人用户名" autocomplete="off" class="layui-input">
					</div>
				</div>
