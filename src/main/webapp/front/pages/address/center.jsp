				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="name" id="name" placeholder="收货人" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="isdefault" id="isdefault" placeholder="是否默认地址[是/否]" autocomplete="off" class="layui-input">
							</div>
						</div>
